...
//STL.cpp : Defines entry point for the console application
#include <iostream>
#include <string>
#include <vector>
#include <numeric>
...
int total3=accumuate(begin(integers),end(integers),0);
...
int numberodds=count_if(begin(integers),end(integers),[](int i)
{return i %2==1;});
...
string sentence=" This is a sentence being stores in a std:: string instance";
